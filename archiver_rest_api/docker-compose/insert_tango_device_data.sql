...
INSERT INTO att_conf (att_conf_id,att_name,att_conf_type_id,att_conf_format_id,att_conf_write_id,table_name,cs_name,domain,family,member,name,ttl,hide) VALUES ('116','tango://tango-databaseds:10000/sys/tg_test/1/short_scalar_ro','2','1','1','att_scalar_devshort','tango-databaseds:10000','sys','tg_test','1','short_scalar_ro','0','f') ON CONFLICT (att_conf_id) DO NOTHING;
INSERT INTO att_conf (att_conf_id,att_name,att_conf_type_id,att_conf_format_id,att_conf_write_id,table_name,cs_name,domain,family,member,name,ttl,hide) VALUES ('147','tango://tango-databaseds:10000/sys/tg_test/1/double_scalar','5','1','4','att_scalar_devdouble','tango-databaseds:10000','sys','tg_test','1','double_scalar','0','f') ON CONFLICT (att_conf_id) DO NOTHING;
INSERT INTO att_conf (att_conf_id,att_name,att_conf_type_id,att_conf_format_id,att_conf_write_id,table_name,cs_name,domain,family,member,name,ttl,hide) VALUES ('146','tango://tango-databaseds:10000/sys/tg_test/1/float_scalar','4','1','4','att_scalar_devfloat','tango-databaseds:10000','sys','tg_test','1','float_scalar','0','f') ON CONFLICT (att_conf_id) DO NOTHING;
INSERT INTO att_conf (att_conf_id,att_name,att_conf_type_id,att_conf_format_id,att_conf_write_id,table_name,cs_name,domain,family,member,name,ttl,hide) VALUES ('117','tango://tango-databaseds:10000/sys/tg_test/1/double_image','5','3','4','att_image_devdouble','tango-databaseds:10000','sys','tg_test','1','double_image','0','f') ON CONFLICT (att_conf_id) DO NOTHING;
